      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            disabled={isCompleting || (!((user?.role === 'SUPER_ADMIN' || user?.role === 'ADMIN') && !systemConfig.requireAdminShift) && !activeShift)}
            title={(!((user?.role === 'SUPER_ADMIN' || user?.role === 'ADMIN') && !systemConfig.requireAdminShift) && !activeShift) ? "You must start a shift before recording sales" : ""}
          >
